...
RUN git clone --recurse-submodules https://github.com/FaaSTCC/annaTCC.git anna
RUN git clone --recurse-submodules https://github.com/FaaSTCC/cacheTCC anna-cache
RUN git clone --recurse-submodules https://github.com/FaaSTCC/cloudburstTCC.git cloudburst
RUN git clone --recurse-submodules https://github.com/FaaSTCC/clusterTCC cluster
