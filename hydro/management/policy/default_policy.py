...
class DefaultHydroPolicy(BaseHydroPolicy):
    ...
    def replica_policy(self, function_frequencies, function_runtimes,
        ...
        for fname in function_frequencies:
            ...
            if fname in self.function_locations:
                ...
                increase = self.max_num_replicas - num_replicas
            ...
            #    if num_replicas < self.max_num_replicas:
            ...
            #            new_num_replicas = (math.ceil(ratio) -
            ...
            #            new_num_replicas = self.max_num_replicas - num_replicas
            #            self.scaler.replicate_function(fname, new_num_replicas,
            #                                           self.function_locations,
            #                                           cpu_executors)
